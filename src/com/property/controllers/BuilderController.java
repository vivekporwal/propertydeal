...
public class BuilderController 
{
	...
	{
		session.setAttribute("userhome", "/PropertyDeal/builder/homepage");
		session.setAttribute("userhomepage", "/builder/homepage");
		session.setAttribute("delprop", "/PropertyDeal/builder/deleteprop");
		session.setAttribute("delreq", "/PropertyDeal/builder/deletereq");
		session.setAttribute("editprofile", "../../PropertyDeal/builder/profile");
		session.setAttribute("usersearch", "/PropertyDeal/builder/usersearch");
		session.setAttribute("usersearchedprops", "/PropertyDeal/builder/usersearchedprops");
		...
		return new ModelAndView("builderhomepage","user",reg);
	...
	public ModelAndView profile(HttpSession session)
	{
		...
		return new ModelAndView("updatebuilderprofile","user",reg);

...
public class BrokerController 
{
	...
	{
		session.setAttribute("userhome", "/PropertyDeal/broker/homepage");
		session.setAttribute("userhomepage", "/broker/homepage");
		session.setAttribute("delprop", "/PropertyDeal/broker/deleteprop");
		session.setAttribute("delreq", "/PropertyDeal/broker/deletereq");
		session.setAttribute("editprofile", "../../PropertyDeal/broker/profile");
		session.setAttribute("usersearch", "../../PropertyDeal/broker/usersearch");
		session.setAttribute("usersearchedprops", "/PropertyDeal/broker/usersearchedprops");
		...
		return new ModelAndView("brokerhomepage","user",reg);
	}
	...
	public ModelAndView profile(HttpSession session)
	{
		...
		return new ModelAndView("updatebrokerprofile","user",reg);
	...
	public  String delProperty(HttpSession session,HttpServletRequest request)
	{
		...
		return "redirect:/broker/homepage";
	}
